...
| Serial no. | Designator | Description |
|---|---|---|
| 1.01 | [1K *Buran*](/buran/orbiters/2K/) | The first flight series orbiter of the program. Flew the only orbital flight of the program. Buran was the first of these orbiters and received the designation 1K (Vehicle 1). |
