...
nav_order: 1
---
*The content of this page is adapted from Semyonov (ed.) 1995, ch. 3.3, with additional information from Lozino-Lozinsky (ed.) 1997 and airframe blueprints published by Vadim Lukashevich on [buran.ru](http://www.buran.ru/htm/cherch3.htm). See [Bibliography](#biblio) for more details.*

## Contents
- [Coordinate system](#coords)
- [Airframe](#airframe)
- [Fuselage](#fuselage)
   - [Forward fuselage](#fwdfuse)
   - [Mid-fuselage](#midfuse)
   - [Aft fuselage](#aftfuse)
    - [Body flap](#bflap)
...
The fuselage is 30,850 mm long (including the nose cap), 5,500 mm wide (across mold line; excluding payload bay door hinges and wing carry-through eyelets) and 6,200 mm tall. Internal documentation treats it as two major sections: F-1, which is the forward fuselage (NChF); and F-2, which consists of the mid-fuselage (SChF) and the aft fuselage (KhChF).

### Forward fuselage {#fwdfuse}
The forward fuselage is 8,700 mm long, 5,500 mm wide and 6,000 mm tall and houses the [Cabin Module (MK)](/buran/tech/cabinmodule/) and nose ODU block along with other systems. 
...
Frames 7A, 8 and 8A, located near the nose landing gear compartment, are each split in three sections. The two full-height vertical segments either side are standard flange-web constructions with corrugated aluminum webs. The lower central section is built around the landing gear compartment, with a truss structure with VT23 titanium diagonals either side. Frame 8A serves as the landing gear compartment's aft bulkhead.

Frames 9A, 10A and 11A are partial frames; they feature narrowed full-height vertical segments at either side, but omit the central flanges and diagonals, using a single rib along the bottom surface of the fuselage instead. These frames form three double-width bays, where the fuel cells with their tankage and instrumentation are installed.
...
The outside surface of the mid-fuselage is divided into four sections along the length of the fuselage, connected by bolts. In each section, the bottom and sides of the fuselage consist of chemically milled skin panels with open-section stringers spaced 140 mm apart on center. In the wing carry-through and main landing gear trunnion area of the wing attachment interface, milled titanium panels with vertical stiffeners are used instead of the aluminum skins. The panels forward of the wing carry-through support the main landing gear on the inboard side.

Skin-stringer panels on the sides of the fuselage have cutouts for hatches of the [airframe pressurization and ventilation system (SNVP)](/buran/tech/snvp/) and for oxygen and hydrogen fill hatches for the [fuel cell (EChG)](/buran/tech/fuelcell/). Each side has six actuated, inward-opening SNVP hatches measuring 510 x 200 mm and fitted with rubber seals. Fuel cell fill hatches are 500 x 600 mm and open outwards; they are fitted with rubber seals, thermal barriers and a locking system; they are opened by hand by pad personnel.
...
Electrical cables run along cable trays located on both sides of the payload bay. The starboard tray also accommodates the ODU propellant lines, which allow crossfeed between the ODU base block at the rear of the orbiter and the nose ODU cluster. Thermal insulation cloth blankets (analogous to the Beta cloth used in the American program) are fitted over the sill longerons and payload bay door longerons to stabilize the thermal environment within the payload bay.
...
| Airframe | Mass (kg)|
|---|---|
| [0.01](/buran/orbiters/okm/)| 20,060.306 |
| [0.02](/buran/orbiters/okgli/)| n/a |
| [0.03](/buran/orbiters/okks/)| 23,441.096 |
| [0.04](/buran/orbiters/okmt/)| 9,921.127 |
| [0.05](/buran/orbiters/oktva/)| n/a |
| [0.06](/buran/orbiters/oktvi/)| n/a |
| [0.16](/buran/orbiters/ok016/)| 10,139.833 |
| [1.01](/buran/orbiters/1kburan/)| 10,237.670 |
| [1.02](/buran/orbiters/2k/)| 10,256.333 |
| [2.01](/buran/orbiters/3k/)| 10,222.692 |
| [2.02](/buran/orbiters/4k/)| 10,190.008 |
| Design mass | 9,161 |
...
### Aft fuselage {#aftfuse}
The aft fuselage section is 3,600 mm long, 5,500 mm wide and 6,000 mm tall. It is joined to the mid-fuselage at the forward end, the wing consoles at the sides and it supports the vertical stabiliser and the body flap as well as the [Integrated Propulsion System (ODU)](/buran/tech/odu/) Base Block along with two aft ODU thruster blocks.
...
Along with the ODU, the aft fuselage houses a number of orbiter systems. At the bottom and offset to the port side, the high gain ONA-II is stowed in a compartment protected by an outward-opening door. The door is held by ten electrically-driven locks and is fitted with two rubber seals. Three [Auxiliary Power Units (VSU)](/buran/tech/vsu/) are mounted behind the frame 22 bulkhead; two on the starboard side and one on the port side.

Two niches for the [Air-Breathing Propulsion System (VRDU)](/buran/tech/vrdu/) turbofan engines are located on the aft fuselage shoulders. The use of VRDU engines on first series orbiters was abandoned in late-1987 or early-1988 and the niches on orbiters 1K and 2K were closed off with aluminum panels and covered in thermal blankets. The aft fuselage of [second series orbiters](/buran/tech/secondseries/) does not feature the niches at all.
...
| Airframe | Mass (kg)|
|---|---|
| [0.01](/buran/orbiters/okm/)| n/a |
| [0.02](/buran/orbiters/okgli/)| n/a |
| [0.03](/buran/orbiters/okks/)| n/a |
| [0.04](/buran/orbiters/okmt/)| 4,907.850 |
| [0.05](/buran/orbiters/oktva/)| 5,888.720 |
| [0.06](/buran/orbiters/oktvi/)| 3,950.652 |
| [0.16](/buran/orbiters/ok016/)| n/a |
| [1.01](/buran/orbiters/1kburan/)| 5,597.464-5,934.399 |
| [1.02](/buran/orbiters/2k/)| 5,636.842 - 5,770.045 |
| [2.01](/buran/orbiters/3k/)| n/a |
| [2.02](/buran/orbiters/4k/)| n/a |
...
trailing edge dihedral
The wing console is constructed from spars planar to the fuselage frames, ribs and skin-stringer panels, with a leading edge spar at the forward edge.
...
- Airframe blueprints published by Vadim Lukashevich on [buran.ru](http://www.buran.ru/htm/cherch3.htm)



<figure>
  <a href="https://buranarchive.space/picture?/6701/category/259-buranspace_graphics"><img src="https://buranarchive.space/i?/uploads/9/m/h/9mhfyeon1r//2026/06/24/20260624222302-e6cfd339-me.jpg" style="max-width: 80%; height: auto;"/></a>
  <figcaption>Buran orbiter attachment points to the Energia.</figcaption>
</figure>
